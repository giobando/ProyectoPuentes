...
"}"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_FrecCorte.setText(_translate("MainWindow", "Frec. de Corte (Hz)", None))
        self.comboBox_FrecFiltroON.setItemText(0, _translate("MainWindow", "5", None))
        self.comboBox_FrecFiltroON.setItemText(1, _translate("MainWindow", "10", None))
        self.comboBox_FrecFiltroON.setItemText(2, _translate("MainWindow", "21", None))
        self.comboBox_FrecFiltroON.setItemText(3, _translate("MainWindow", "44", None))
        self.comboBox_FrecFiltroON.setItemText(4, _translate("MainWindow", "94", None))
        self.comboBox_FrecFiltroON.setItemText(5, _translate("MainWindow", "184", None))
        self.comboBox_FrecFiltroON.setItemText(6, _translate("MainWindow", "260", None))
