...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setStyleSheet(_fromUtf8("#MainWindow_NodoCentral{\n"
"    \n"
...
"}"))
        ...
        self.groupBox.setGeometry(QtCore.QRect(10, 10, 221, 321))
...
"}"))
        ...
        self.label_titulo1.setGeometry(QtCore.QRect(40, 10, 138, 21))
        font = QtGui.QFont()
        ...
        self.checkBox_FourierVisualizar.setGeometry(QtCore.QRect(120, 280, 65, 20))
        ...
        self.label_tituloVisualizarGrafica.setGeometry(QtCore.QRect(10, 260, 161, 18))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.checkBox_VibracionesVisualizar.setGeometry(QtCore.QRect(26, 280, 88, 20))
        ...
        self.horizontalSlider_Duracion.setGeometry(QtCore.QRect(20, 236, 181, 20))
        ...
        self.label_DuracionDatos.setGeometry(QtCore.QRect(119, 210, 48, 15))
        self.label_DuracionDatos.setObjectName(_fromUtf8("label_DuracionDatos"))
        self.label_DuracionTexto = QtGui.QLabel(self.groupBox)
        self.label_DuracionTexto.setGeometry(QtCore.QRect(10, 210, 81, 16))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        self.label_DuracionTexto.setFont(font)
        ...
        self.label_tituloDatosVisualizar.setGeometry(QtCore.QRect(10, 130, 106, 18))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(20, 150, 181, 50))
        ...
        self.pushButton_actualizarNodos.setGeometry(QtCore.QRect(140, 80, 57, 23))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.comboBox_nombreSensor.setGeometry(QtCore.QRect(65, 102, 64, 25))
...
"}"))
        ...
        self.layoutWidget1 = QtGui.QWidget(self.groupBox_UnidadesAcelerometro)
        self.layoutWidget1.setGeometry(QtCore.QRect(12, 28, 201, 74))
        self.layoutWidget1.setObjectName(_fromUtf8("layoutWidget1"))
        self.gridLayout_3 = QtGui.QGridLayout(self.layoutWidget1)
        self.gridLayout_3.setObjectName(_fromUtf8("gridLayout_3"))
        self.label_UnitsAcc = QtGui.QLabel(self.layoutWidget1)
        self.label_UnitsAcc.setObjectName(_fromUtf8("label_UnitsAcc"))
        self.gridLayout_3.addWidget(self.label_UnitsAcc, 0, 0, 1, 1)
        self.radioButton_gUnitsACC = QtGui.QRadioButton(self.layoutWidget1)
        ...
        self.radioButton_ms2UnitsACC = QtGui.QRadioButton(self.layoutWidget1)
        ...
        self.label_sensibilidad = QtGui.QLabel(self.layoutWidget1)
        ...
        self.radioButton_sensibilidad2gACC = QtGui.QRadioButton(self.layoutWidget1)
        ...
        self.radioButton_sensibilidad8gACC = QtGui.QRadioButton(self.layoutWidget1)
        ...
        self.radioButton_sensibilidad4gACC = QtGui.QRadioButton(self.layoutWidget1)
        ...
        self.radioButton_sensibilidad16gACC = QtGui.QRadioButton(self.layoutWidget1)
        ...
        self.layoutWidget2 = QtGui.QWidget(self.groupBox_UnidadesGiroscopio)
        self.layoutWidget2.setGeometry(QtCore.QRect(1, 21, 224, 74))
        self.layoutWidget2.setObjectName(_fromUtf8("layoutWidget2"))
        self.gridLayout_2 = QtGui.QGridLayout(self.layoutWidget2)
        self.gridLayout_2.setObjectName(_fromUtf8("gridLayout_2"))
        self.label_UnitsGyro = QtGui.QLabel(self.layoutWidget2)
        self.label_UnitsGyro.setObjectName(_fromUtf8("label_UnitsGyro"))
        self.gridLayout_2.addWidget(self.label_UnitsGyro, 0, 0, 1, 1)
        self.label_sensibilidadGyro = QtGui.QLabel(self.layoutWidget2)
        ...
        self.radioButton_sensibilidad2gGyro = QtGui.QRadioButton(self.layoutWidget2)
        ...
        self.radioButton_sensibilidad8gGyro = QtGui.QRadioButton(self.layoutWidget2)
        ...
        self.radioButton_sensibilidad4gGyro = QtGui.QRadioButton(self.layoutWidget2)
        ...
        self.radioButton_sensibilidad16gGyro = QtGui.QRadioButton(self.layoutWidget2)
        ...
        self.checkBox_UnitsGyro = QtGui.QCheckBox(self.layoutWidget2)
        ...
        self.label.setGeometry(QtCore.QRect(60, 300, 171, 16))
        font = QtGui.QFont()
        font.setPointSize(7)
        font.setBold(True)
        font.setWeight(75)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox_FrecMuestreoOFF.setItemText(0, _translate("MainWindow", "60", None))
        self.comboBox_FrecMuestreoOFF.setItemText(1, _translate("MainWindow", "95", None))
        self.comboBox_FrecMuestreoOFF.setItemText(2, _translate("MainWindow", "115", None))
        self.comboBox_FrecMuestreoOFF.setItemText(3, _translate("MainWindow", "181", None))
        self.comboBox_FrecMuestreoOFF.setItemText(4, _translate("MainWindow", "333", None))
        self.comboBox_FrecMuestreoOFF.setItemText(5, _translate("MainWindow", "363", None))
        self.comboBox_FrecMuestreoOFF.setItemText(6, _translate("MainWindow", "400", None))
        self.comboBox_FrecMuestreoOFF.setItemText(7, _translate("MainWindow", "500", None))
        self.comboBox_FrecMuestreoOFF.setItemText(8, _translate("MainWindow", "615", None))
        self.comboBox_FrecMuestreoOFF.setItemText(9, _translate("MainWindow", "800", None))
        ...
        self.comboBox_FrecMuestreoON.setItemText(0, _translate("MainWindow", "60", None))
        self.comboBox_FrecMuestreoON.setItemText(1, _translate("MainWindow", "95", None))
        self.comboBox_FrecMuestreoON.setItemText(2, _translate("MainWindow", "115", None))
        self.comboBox_FrecMuestreoON.setItemText(3, _translate("MainWindow", "181", None))
        self.comboBox_FrecMuestreoON.setItemText(4, _translate("MainWindow", "333", None))
        self.comboBox_FrecMuestreoON.setItemText(5, _translate("MainWindow", "363", None))
        self.comboBox_FrecMuestreoON.setItemText(6, _translate("MainWindow", "400", None))
        self.comboBox_FrecMuestreoON.setItemText(7, _translate("MainWindow", "500", None))
        self.comboBox_FrecMuestreoON.setItemText(8, _translate("MainWindow", "615", None))
        self.comboBox_FrecMuestreoON.setItemText(9, _translate("MainWindow", "800", None))
        self.label_FiltroConFrecuencia.setText(_translate("MainWindow", "** Frec. Bajas sii El filtro pasa baja esta activado.", None))
        self.tabWidget_system.setTabText(self.tabWidget_system.indexOf(self.tab_FiltroFrec), _translate("MainWindow", "Filtro y Frec.", None))
        ...
        self.radioButton_sensibilidad8gGyro.setText(_translate("MainWindow", "500", None))
        self.radioButton_sensibilidad4gGyro.setText(_translate("MainWindow", "1000", None))
