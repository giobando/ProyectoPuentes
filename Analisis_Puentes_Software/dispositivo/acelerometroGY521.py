...
'''
Basado de:
www.tutorials-raspberrypi.com/measuring-rotation-and-acceleration-raspberry-pi/

El siguiente codigo toma como referencia el sensor gy-521
'''
...
# CONSTANTES!!
from constantes.const import ACCE_POWER_MGMT_1, ACCE_POWER_MGMT_2
from constantes.const import I2C_ARM, I2C_VC
...
class AccGy521:
    ...
    bus = smbus.SMBus(I2C_ARM)  # la siguiente linea corresponde al i2c asociado
