...
# EL DISPOSITIVO DEBE D ESTAR EN UNA SUPERFICIE TOTALMENTE PLANA, POR FAVOR SI ES POSIBLE UTILICE UN INCLINOMETRO.
    ...
    while True:      
        ...
        if pidax.check_time():
            ...
            if axindex == len(x_accel_avg):
                ...
                print("============================================================================================================================================================")
                print("time: "+ timeNow)
                x_print = 'x_avg_read: ' + str(avg_from_array(x_accel_avg)) +'\t x_avg_offset: ' + str(avg_from_array(x_accel_offset_avg))
                y_print = '\ty_avg_read: ' + str(avg_from_array(y_accel_avg)) +'\t y_avg_offset: ' + str(avg_from_array(y_accel_offset_avg))
                z_print = '\tz_avg_read: ' + str(avg_from_array(z_accel_avg)) +'\t z_avg_offset: ' + str(avg_from_array(z_accel_offset_avg))
                print("ACCELEROMETRO \t" + x_print + y_print + z_print)
##                
##                print('x_avg_read: ' +
...
##                x_print_gyro = 'x_avg_read: ' + str(avg_from_array(x_gyro_avg)) +'\t x_avg_offset: ' + str(avg_from_array(x_gyro_offset_avg))
##                y_print_gyro = '\ty_avg_read: ' +  str(avg_from_array(y_gyro_avg))+'\t y_avg_offset: ' + str(avg_from_array(y_gyro_offset_avg))
##                z_print_gyro = '\tz_avg_read: ' + str(avg_from_array(z_gyro_avg)) +'\t z_avg_offset: ' +  str(avg_from_array(z_gyro_offset_avg))
                print("GYROSCOPIO ")
